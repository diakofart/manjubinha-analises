...
def build_ranking_html(ranking):
    ...
    .mjk{font-weight:600;font-size:13px;display:flex;align-items:center;gap:5px}
    ...
    js_funcs = (
                ...
                "var dotClr=d.nota>=8?'#639922':d.nota>=5?'#BA7517':'#E24B4A';"
                ...
                "<td class=mjk><span class=mjd style=\\'background:'+dotClr+'\\'></span>'+lnk+bdg+'</td>"
